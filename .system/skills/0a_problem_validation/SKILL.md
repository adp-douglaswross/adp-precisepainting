...
description: Gofer Problem Validation
gofer:
  workflowProfile: standard
  canonicalSource: .specify/commands/0a_problem_validation.md
  canonicalChecksum: 6c38c6d9e8207e72f3b34959b4e82d236dd2c50ea159d94c6b5c32aa11cdf022
...
```
**Note**: Codex CLI does not support the Task tool. For parallel agent work, open multiple Codex CLI sessions and run the research-market-scanner analysis in each., model="haiku"
