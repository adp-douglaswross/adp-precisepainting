---
name: 6-gofer-validate
description: "Run the 6_gofer_validate Gofer workflow stage"
gofer:
  workflowProfile: enterpriseai
  canonicalCommand: 6_gofer_validate
...
# Gofer Command: 6_gofer_validate

Use this skill when the user asks for `6_gofer_validate`, `#6_gofer_validate`, or `6-gofer-validate`.
