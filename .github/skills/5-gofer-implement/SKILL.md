---
name: 5-gofer-implement
description: "Run the 5_gofer_implement Gofer workflow stage"
gofer:
  workflowProfile: enterpriseai
  canonicalCommand: 5_gofer_implement
...
# Gofer Command: 5_gofer_implement

Use this skill when the user asks for `5_gofer_implement`, `#5_gofer_implement`, or `5-gofer-implement`.
