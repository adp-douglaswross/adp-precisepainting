---
name: 1-gofer-research
description: "Run the 1_gofer_research Gofer workflow stage"
gofer:
  workflowProfile: enterpriseai
  canonicalCommand: 1_gofer_research
...
# Gofer Command: 1_gofer_research

Use this skill when the user asks for `1_gofer_research`, `#1_gofer_research`, or `1-gofer-research`.
