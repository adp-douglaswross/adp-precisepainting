---
name: gofer-diagnose
description: "Run the gofer_diagnose Gofer workflow stage"
gofer:
  workflowProfile: enterpriseai
  canonicalCommand: gofer_diagnose
  canonicalSource: .claude/commands/gofer_diagnose.md
  canonicalChecksum: 0fdc81db3a88efdb76f67ef3503b0997f9de4a80645312ae3bb4e0915131e4fe
  metadataSource: eai/resources/gofer
---

# Gofer Command: gofer_diagnose

Use this skill when the user asks for `gofer_diagnose`, `#gofer_diagnose`, or `gofer-diagnose`.
