...
description: "Run the gofer_bootstrap_workspace Gofer workflow stage"
gofer:
  workflowProfile: enterpriseai
  canonicalCommand: gofer_bootstrap_workspace
  canonicalSource: .claude/commands/gofer_bootstrap_workspace.md
  canonicalChecksum: 49ba02c80cf374af77f40e10fee49b4c71c389a2da01b402480b2e5e7b607b03
  metadataSource: eai/resources/gofer
---

# Gofer Command: gofer_bootstrap_workspace

Use this skill when the user asks for `gofer_bootstrap_workspace`, `#gofer_bootstrap_workspace`, or `gofer-bootstrap-workspace`.
