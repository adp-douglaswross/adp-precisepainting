---
name: 8-gofer-resume
description: "Run the 8_gofer_resume Gofer workflow stage"
gofer:
  workflowProfile: enterpriseai
  canonicalCommand: 8_gofer_resume
...
# Gofer Command: 8_gofer_resume

Use this skill when the user asks for `8_gofer_resume`, `#8_gofer_resume`, or `8-gofer-resume`.
