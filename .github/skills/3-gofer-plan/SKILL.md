---
name: 3-gofer-plan
description: "Run the 3_gofer_plan Gofer workflow stage"
gofer:
  workflowProfile: enterpriseai
  canonicalCommand: 3_gofer_plan
...
# Gofer Command: 3_gofer_plan

Use this skill when the user asks for `3_gofer_plan`, `#3_gofer_plan`, or `3-gofer-plan`.
