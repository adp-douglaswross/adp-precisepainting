---
name: gofer-hydrate
description: "Run the gofer_hydrate Gofer workflow stage"
gofer:
  workflowProfile: enterpriseai
  canonicalCommand: gofer_hydrate
...
# Gofer Command: gofer_hydrate

Use this skill when the user asks for `gofer_hydrate`, `#gofer_hydrate`, or `gofer-hydrate`.
