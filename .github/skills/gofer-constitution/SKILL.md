---
name: gofer-constitution
description: "Run the gofer_constitution Gofer workflow stage"
gofer:
  workflowProfile: enterpriseai
  canonicalCommand: gofer_constitution
...
# Gofer Command: gofer_constitution

Use this skill when the user asks for `gofer_constitution`, `#gofer_constitution`, or `gofer-constitution`.
