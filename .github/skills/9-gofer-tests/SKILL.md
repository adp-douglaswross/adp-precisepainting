---
name: 9-gofer-tests
description: "Run the 9_gofer_tests Gofer workflow stage"
gofer:
  workflowProfile: enterpriseai
  canonicalCommand: 9_gofer_tests
...
# Gofer Command: 9_gofer_tests

Use this skill when the user asks for `9_gofer_tests`, `#9_gofer_tests`, or `9-gofer-tests`.
